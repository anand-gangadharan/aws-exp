...
```bash
sam-lambda-app$ sam logs -n HelloEfsFunction --stack-name "sam-lambda-app" --tail
```
...
```bash
sam-lambda-app$ pip install -r tests/requirements.txt --user
# unit test
sam-lambda-app$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
sam-lambda-app$ AWS_SAM_STACK_NAME="sam-lambda-app" python -m pytest tests/integration -v
```
...
```bash
sam delete --stack-name "sam-lambda-app"
```
